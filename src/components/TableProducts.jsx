        ...
        <table className="min-w-full divide-y divide-gray-300">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {products.map((product) => (
              <tr key={product._id}>
                <td className="hidden whitespace-nowrap py-4 pl-3 pr-3 text-xs text-primary-500 sm:pl-6 lg:table-cell md:text-sm capitalize">
                  {product.name}
                </td>
                ...
                <td className="hidden whitespace-nowrap py-4 pl-3 pr-3 text-xs text-primary-500 sm:pl-6 lg:table-cell md:text-sm">
                  {new Date(product.dateEntry).toLocaleString('es-ES', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                <td className="whitespace-nowrap px-3 py-4 text-xs text-gray-500 sm:text-sm capitalize">
                  {product.type}
                </td>
